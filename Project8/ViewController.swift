...
class ViewController: UIViewController {
    ...
    func showAlert() {
        let ac = UIAlertController(title: "Attention!", message: "You wrote the wrong word! Please enter again", preferredStyle: .alert)
